...
class ControleurTableau extends ControleurGenerique
{
    ...
    #[Route(path: '/tableau/{idTableau}/mise-a-jour', name:'mettre_a_jour_tableau', methods:["GET"])]
    ...
    public static function quitterTableau(string $idtableau): void {
        if(!ConnexionUtilisateur::estConnecte()) {
            ControleurTableau::redirection("utilisateur", "afficherFormulaireConnexion");
        }
        if(!ControleurCarte::issetAndNotNull(["idTableau"])) {
    ...
    public static function supprimerTableau(string $idTableau): void {
        if(!ConnexionUtilisateur::estConnecte()) {
            ControleurTableau::redirection("utilisateur", "afficherFormulaireConnexion");
        }
        if(!ControleurCarte::issetAndNotNull(["idTableau"])) {
